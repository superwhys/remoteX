...
type FileSender interface {
	SendFiles(ctx context.Context, rw protoutils.ProtoMessageReadWriter, path string, opts *SyncOpt) (err error)
}

type Sender struct{}

func (s *Sender) SendFiles(ctx context.Context, rw protoutils.ProtoMessageReadWriter, path string, opts *SyncOpt) (err error) {
...
func (st *sendTransfer) sendFileList(ctx context.Context, root string) (*FileList, error) {
	...
	if err := st.rw.WriteMessage(&FileBase{IsEnd: true}); err != nil {
