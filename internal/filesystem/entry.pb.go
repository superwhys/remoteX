...
// source: internal/filesystem/entry.proto
...
func (EntryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a5928a5b068b609d, []int{0}
}
...
type Entry struct {
	...
	Regular      bool      `protobuf:"varint,10,opt,name=regular,proto3" json:"regular" yaml:"-"`
	Children     []*Entry  `protobuf:"bytes,11,rep,name=children,proto3" json:"children,omitempty" yaml:"-"`
}
...
func (*ListResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_a5928a5b068b609d, []int{1}
}
...
func init() {
	proto.RegisterEnum("filesystem.EntryType", EntryType_name, EntryType_value)
	proto.RegisterType((*Entry)(nil), "filesystem.Entry")
	proto.RegisterType((*ListResp)(nil), "filesystem.ListResp")
}

func init() { proto.RegisterFile("internal/filesystem/entry.proto", fileDescriptor_a5928a5b068b609d) }

var fileDescriptor_a5928a5b068b609d = []byte{
	// 606 bytes of a gzipped FileDescriptorProto
	,
}
